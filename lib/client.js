...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const VARIANTS = {
			smile: { grid: SITTING, anim: "tw-bob 3s ease-in-out infinite", blinkMs: 2800, colorFn: (p) => ({ body: p.body, eye: p.eye, mouth: p.mouth, tear: null, accent: p.dark }) },
